...
public class IconPack {
    ...
    IconPack(Context context, String packageName) {
        ...
        parseIconPack(context, packageName);
    }
     ...
     * @param packageName Android package ID of the package to parse
     */
    private void parseIconPack(Context context, String packageName) {
    ...
    /**
     * @param drawableIdentifier The identifier to look for in the iconpack's ressources
     * @return The drawable, is found, or null
     */
    @Nullable
    private BitmapDrawable loadBitmapFromIconPack(String drawableIdentifier) {
    ...
    /**
     * Get or generate an icon from the iconpack from a ComponentName
     */
    public Drawable getIcon(Context context, ComponentName componentName) throws PackageManager.NameNotFoundException {
        ...
        if (drawableIdentifier != null) {
            ...
            return loadBitmapFromIconPack(drawableIdentifier);
        }
